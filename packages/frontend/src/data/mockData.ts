...
const useCaseCards: Card[] = [
  ...
  { id: 'uc-09', type: 'useCase', title: 'Caso de Uso 9', description: 'Escrever e revisar e-mails em inglês', image: '/cards/use-case/use-case-09.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-20', type: 'useCase', title: 'Caso de Uso 20', description: 'Gerar uma análise SWOT com base em documentos de um workshop estratégico', image: '/cards/use-case/use-case-20.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-01', type: 'useCase', title: 'Caso de Uso 1', description: 'Criar uma FAQ sobre um determinado assunto para apoiar o time comercial', image: '/cards/use-case/use-case-01.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-10', type: 'useCase', title: 'Caso de Uso 10', description: 'Resumir chats e conversas de grupos no Teams', image: '/cards/use-case/use-case-10.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-05', type: 'useCase', title: 'Caso de Uso 5', description: 'Elaborar atas simples e listas de to-dos (afazeres) a partir de reuniões com clientes', image: '/cards/use-case/use-case-05.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-19', type: 'useCase', title: 'Caso de Uso 19', description: 'Criar um agente que responde dúvidas frequentes sobre políticas internas. Exemplo: Um bot que responda automaticamente perguntas sobre benefícios, férias ou processos de RH.', image: '/cards/use-case/use-case-19.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'uc-02', type: 'useCase', title: 'Caso de Uso 2', description: 'Gerar resumos dos e-mails recebidos na data de ontem', image: '/cards/use-case/use-case-02.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  // Round 2 (6 UCs) - matches: UC4+Word, UC8+Word, UC15+Researcher, UC16+Researcher, UC17+Notebook, UC18+Notebook
  { id: 'uc-17', type: 'useCase', title: 'Caso de Uso 17', description: 'Resumir entrevistas longas em formatos mais curtos', image: '/cards/use-case/use-case-17.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'uc-04', type: 'useCase', title: 'Caso de Uso 4', description: 'Elaborar uma proposta comercial a partir da transcrição de uma reunião referenciada', image: '/cards/use-case/use-case-04.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'uc-16', type: 'useCase', title: 'Caso de Uso 16', description: 'Coletar referências sobre a concorrência para um projeto de inovação', image: '/cards/use-case/use-case-16.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'uc-08', type: 'useCase', title: 'Caso de Uso 8', description: 'Analisar transcrições de reuniões para gerar atas detalhadas e robustas', image: '/cards/use-case/use-case-08.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'uc-15', type: 'useCase', title: 'Caso de Uso 15', description: 'Preparar benchmarking para uma proposta de melhoria de processos', image: '/cards/use-case/use-case-15.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'uc-18', type: 'useCase', title: 'Caso de Uso 18', description: 'Analisar transcrições de reuniões para gerar relatórios executivos', image: '/cards/use-case/use-case-18.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  // Round 3 (3 UCs) - matches: UC3+PowerPoint, UC11+Create, UC12+Create
  { id: 'uc-11', type: 'useCase', title: 'Caso de Uso 11', description: 'Criar slides para uma reunião de status com base em um relatório', image: '/cards/use-case/use-case-11.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  { id: 'uc-03', type: 'useCase', title: 'Caso de Uso 3', description: 'Elaborar materiais de apoio para apresentações executivas utilizando um template corporativo e arquivos PDF como referência de conteúdo', image: '/cards/use-case/use-case-03.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  { id: 'uc-12', type: 'useCase', title: 'Caso de Uso 12', description: 'Gerar imagens conceituais para uma campanha interna de engajamento', image: '/cards/use-case/use-case-12.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  // Round 4 (4 UCs) - matches: UC6+Excel, UC7+Excel, UC13+Analyst, UC14+Analyst
  { id: 'uc-14', type: 'useCase', title: 'Caso de Uso 14', description: 'Avaliar tendências de uma base de clientes', image: '/cards/use-case/use-case-14.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'uc-06', type: 'useCase', title: 'Caso de Uso 6', description: 'Analisar indicadores relevantes para uma área de negócio', image: '/cards/use-case/use-case-06.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'uc-07', type: 'useCase', title: 'Caso de Uso 7', description: 'Revisar planilhas e propor análises detalhadas', image: '/cards/use-case/use-case-07.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'uc-13', type: 'useCase', title: 'Caso de Uso 13', description: 'Identificar gargalos em processos com base em dados operacionais', image: '/cards/use-case/use-case-13.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
]

// Prompt Cards (20 cards, distributed and shuffled per round)
const promptCards: Card[] = [
  // Round 1 (7 Prompts) - shuffled: N, G, D, A, P, C, J
  { id: 'prompt-n', type: 'prompt', title: 'Prompt N', description: 'Crie uma matriz SWOT com base nos conteúdos do evento interno, destacando forças internas, fraquezas operacionais, oportunidades externas e ameaças estratégicas. Inclua recomendações para mitigação e aproveitamento. Referencie somente os documentos da pasta em sua pesquisa e análise.', image: '/cards/prompt/prompt-n.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-g', type: 'prompt', title: 'Prompt G', description: "Busque por e-mails, chats e conversas em grupos do Teams onde o assunto 'X' tenha sido mencionado. Liste todas as perguntas e respostas dadas com a devida referência para a checagem das informações. Crie uma FAQ para ser compartilhada com o time de modo a facilitar e padronizar a resposta dessas perguntas.", image: '/cards/prompt/prompt-g.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-d', type: 'prompt', title: 'Prompt D', description: 'Escreva um e-mail em inglês para o cliente [X] perguntando se ele teve a chance de ler o último relatório ou documento que enviei. Pergunte se ele precisa de alguma informação adicional.', image: '/cards/prompt/prompt-d.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-a', type: 'prompt', title: 'Prompt A', description: 'Faça uma ata de reunião contendo a descrição dos principais pontos abordados na reunião com o cliente, "to-dos" (afazeres) definidos e plano de ação para o time responsável.', image: '/cards/prompt/prompt-a.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-p', type: 'prompt', title: 'Prompt P', description: 'Crie um agente que responda perguntas sobre o processo de onboarding. Obs.: Ideal para novos colaboradores.', image: '/cards/prompt/prompt-p.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-c', type: 'prompt', title: 'Prompt C', description: "Faça um resumo dos assuntos que recebi por e-mail na data de ontem. Organize os assuntos compilados em formato de tabela contendo as colunas 'título do e-mail', 'resumo', e 'ação necessária', se aplicável.", image: '/cards/prompt/prompt-c.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  { id: 'prompt-j', type: 'prompt', title: 'Prompt J', description: 'Resuma os assuntos tratados nessa conversa em que fui @mencionado(a).', image: '/cards/prompt/prompt-j.png', roundId: 'round-1', villainTheme: 'mestre-notificacoes', active: true, difficulty: 'easy' },
  // Round 2 (6 Prompts) - shuffled: T, O, H, R, E, L
  { id: 'prompt-t', type: 'prompt', title: 'Prompt T', description: 'Quais são os principais concorrentes nesse segmento?', image: '/cards/prompt/prompt-t.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'prompt-o', type: 'prompt', title: 'Prompt O', description: 'Identifique os temas recorrentes e crie um resumo executivo com base nesse conteúdo. Obs.: Ideal para reuniões ou entrevistas com múltiplos tópicos.', image: '/cards/prompt/prompt-o.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'prompt-h', type: 'prompt', title: 'Prompt H', description: 'Analise o resumo de reunião referenciado e elabore um diagnóstico dos assuntos discutidos ao longo da reunião. Em seguida, escreva uma ata contendo uma comparação / conclusão sobre o assunto X.', image: '/cards/prompt/prompt-h.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'prompt-r', type: 'prompt', title: 'Prompt R', description: 'Pesquise as melhores práticas em processos de onboarding em empresas de tecnologia', image: '/cards/prompt/prompt-r.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'prompt-e', type: 'prompt', title: 'Prompt E', description: 'Você é um profissional comercial. Elabore uma proposta formalizando ao cliente as recomendações discutidas na conversa do arquivo.', image: '/cards/prompt/prompt-e.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  { id: 'prompt-l', type: 'prompt', title: 'Prompt L', description: 'Resuma esse transcript em um roteiro de podcast de 5 minutos com os principais insights. Obs.: O prompt deve ser utilizado após subir o transcript no app do Notebook.', image: '/cards/prompt/prompt-l.png', roundId: 'round-2', villainTheme: 'capita-pesquisa', active: true, difficulty: 'easy' },
  // Round 3 (3 Prompts) - shuffled: Q, M, B
  { id: 'prompt-q', type: 'prompt', title: 'Prompt Q', description: 'Gere um infográfico com os principais insights da pesquisa.', image: '/cards/prompt/prompt-q.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  { id: 'prompt-m', type: 'prompt', title: 'Prompt M', description: 'Crie uma apresentação visual com base nesse relatório executivo.', image: '/cards/prompt/prompt-m.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  { id: 'prompt-b', type: 'prompt', title: 'Prompt B', description: 'Crie uma apresentação a partir do arquivo .', image: '/cards/prompt/prompt-b.png', roundId: 'round-3', villainTheme: 'senhora-perfeccionista', active: true, difficulty: 'easy' },
  // Round 4 (4 Prompts) - shuffled: F, K, S, I
  { id: 'prompt-f', type: 'prompt', title: 'Prompt F', description: 'Analise as colunas B e C e sugira 3 cenários de análise diferentes.', image: '/cards/prompt/prompt-f.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'prompt-k', type: 'prompt', title: 'Prompt K', description: 'Analise essa planilha e me traga os principais riscos financeiros desse processo.', image: '/cards/prompt/prompt-k.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'prompt-s', type: 'prompt', title: 'Prompt S', description: 'Quais padrões você identifica nesses dados de atendimento?', image: '/cards/prompt/prompt-s.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
  { id: 'prompt-i', type: 'prompt', title: 'Prompt I', description: 'Sugira 3 cenários diferentes para a análise dos indicadores. Crie um gráfico de barras para demonstrar o resultado dessa análise.', image: '/cards/prompt/prompt-i.png', roundId: 'round-4', villainTheme: 'ctrlcv', active: true, difficulty: 'easy' },
]
